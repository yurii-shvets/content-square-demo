...
+ (void)forgetMe SWIFT_DEPRECATED_MSG("Will be removed in a future version. You can use `optOut()` instead to forget user id and stop tracking. If needed call `optIn()` when you want to resume tracking.");
...
/// \param name The name of the screenView to track.
///
/// \param cvars Array of custom variables giving additional information about the named screen
///
+ (void)sendWithScreenViewWithName:(NSString * _Nonnull)name cvars:(NSArray<CustomVar *> * _Nonnull)cvars;
...
/// Tracks a user identifier
/// \param userIdentifier The user identifier to track.
///
+ (void)sendUserIdentifier:(NSString * _Nonnull)userIdentifier;
...
/// Represents the current level of messages the SDK logs in the Console.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) enum Level logLevel;)
+ (enum Level)logLevel SWIFT_WARN_UNUSED_RESULT;
+ (void)setLogLevel:(enum Level)newValue;
/// Disables the tracking of gestures within your app.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL isGestureTrackingDisabled SWIFT_DEPRECATED_MSG("Will be removed in a future version");)
...
/// note:
/// If you change the default masking state to <code>false</code>, <code>UIKit.UITextField</code>, <code>UIKit.UITextView</code>,
/// <code>SwiftUI.TextField</code>, <code>SwiftUI.TextEditor</code> will stay masked by default.
/// \param isMasking A Boolean value that indicates whether to set the default masking.
///
+ (void)setDefaultMasking:(BOOL)isMasking;
/// Masks or unmasks all text components.
/// The text component is <code>UILabel</code> for UIKit and <code>Text</code> for SwiftUI.
/// \param mask A Boolean value that indicates whether to mask or unmask.
///
+ (void)maskTexts:(BOOL)mask;
/// Masks or unmasks all image components.
/// The image component is <code>UIImageView</code> for UIKit and <code>Image</code> for SwiftUI.
/// \param mask A Boolean value that indicates whether to mask or unmask.
///
+ (void)maskImages:(BOOL)mask;
/// Masks or unmasks all text input components.
/// The text input components are <code>UITextField</code>, <code>UITextView</code> for UIKit and
/// <code>TextField</code>, <code>SecureField</code>, <code>TextEditor</code> for SwiftUI.
/// \param mask A Boolean value that indicates whether to mask or unmask.
///
+ (void)maskTextInputs:(BOOL)mask;
...
/// Session Replay is enabled depending on your project settings, opt-in status and device capabilities.
/// <h1>See also</h1>
...
@interface Contentsquare (SWIFT_EXTENSION(ContentsquareModule))
/// Name used for the Tap gesture recognizer
/// The name <code>csTapGestureRecognizer</code> is equal to the value “csTapGestureRecognizer”
/// \code
/// print(Contentsquare.csTapGestureRecognizer) // "csTapGestureRecognizer"
///
/// \endcode
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull csTapGestureRecognizer;)
+ (NSString * _Nonnull)csTapGestureRecognizer SWIFT_WARN_UNUSED_RESULT;
/// Name used for the Pan gesture recognizer
/// The name <code>csPanGestureRecognizer</code> is equal to the value “csPanGestureRecognizer”
/// \code
/// print(Contentsquare.csPanGestureRecognizer) // "csPanGestureRecognizer"
///
/// \endcode
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull csPanGestureRecognizer;)
+ (NSString * _Nonnull)csPanGestureRecognizer SWIFT_WARN_UNUSED_RESULT;
/// Name used for the Long Press gesture recognizer
/// The name <code>csLongPressGestureRecognizer</code> is equal to the value “csLongPressGestureRecognizer”
/// \code
/// print(Contentsquare.csLongPressGestureRecognizer) // "csLongPressGestureRecognizer"
///
/// \endcode
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull csLongPressGestureRecognizer;)
+ (NSString * _Nonnull)csLongPressGestureRecognizer SWIFT_WARN_UNUSED_RESULT;
/// Name used for the Gesture recognizer
/// The name <code>csTouchGestureRecognizer</code> is equal to the value “csTouchGestureRecognizer”
/// \code
/// print(Contentsquare.csTouchGestureRecognizer) // "csTouchGestureRecognizer"
///
/// \endcode
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull csTouchGestureRecognizer;)
+ (NSString * _Nonnull)csTouchGestureRecognizer SWIFT_WARN_UNUSED_RESULT;
@end
...
/// A index/name/value object representing a variable containing additionnal information about screen.
/// Custom vars are additional information on the screen, the user or the session, sent within screenviews.
/// They generally include datalayer information, such as: Screen type, Product category,
/// if the user is signed in or not, the number of items in the cart…
/// This information enables user segmentation or screen grouping.
SWIFT_CLASS("_TtC19ContentsquareModule9CustomVar")
@interface CustomVar : NSObject
/// Creates a custom var with the given index, name and value.
/// remark:
///
/// <ul>
///   <li>
///     if <code>name</code> or <code>value</code> are empty, the framework uses the literal string ‘cs-empty’ instead.
///   </li>
///   <li>
///     if <code>name</code> is over 512 characters, the framework will automatically truncate the string.
///   </li>
///   <li>
///     if <code>value</code> is over 255 characters, the framework will automatically truncate the string.
///   </li>
/// </ul>
/// \param index a number identifying a CustomVar. Use consistent index for a given name across the implementation.
///
/// \param name A description of what you want to track. Use the same name to identify occurrences of a same var.
///
/// \param value The string value taken by this occurrence of the var.
///
- (nonnull instancetype)initWithIndex:(uint32_t)index stringName:(NSString * _Nonnull)name stringValue:(NSString * _Nonnull)value;
...
///   </li>
///   <li>
///     if <code>key</code> is over 512 characters, the framework will automatically truncate the string.
///   </li>
///   <li>
///     if <code>value</code> is over 255 characters, the framework will automatically truncate the string.
///   </li>
...
SWIFT_CLASS("_TtC19ContentsquareModule13ErrorAnalysis")
@interface ErrorAnalysis : NSObject
/// Sets the URL masking patterns
/// You can use this API to mask any URL path.
/// For example: the pattern “www.example.com/user/:user_id” would mask all the following URLs
/// “www.example.com/user/198?param=value”
/// “www.example.com/user/199?param=value”
/// to
/// “www.example.com/user/CS_ANONYMIZED_USER_ID?param=value”
/// Note: you don’t need to use this API to mask email addresses, they are masked automatically.
/// \param patterns The patterns used to mask the URL
///
+ (void)setURLMaskingPatterns:(NSArray<NSString *> * _Nonnull)patterns;
/// Sets an action to perform after the crash reporter is started.
/// The closure takes a single Bool argument that indicates whether or not
/// the crash reporter is actually enabled.
+ (void)onCrashReporterStart:(void (^ _Nonnull)(BOOL))onCrashReporterStart;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Instances of <code>HTTPMetric</code> can be used to record HTTP network request information.
SWIFT_CLASS("_TtC19ContentsquareModule10HTTPMetric")
@interface HTTPMetric : NSObject
/// Set the response’s HTTP status code.
- (void)setStatusCode:(NSInteger)statusCode;
/// Set the response body.
- (void)setRequestBody:(NSData * _Nonnull)requestBody;
/// Set the response body.
- (void)setResponseBody:(NSData * _Nonnull)responseBody;
/// Set the request headers.
- (void)setRequestHeaders:(NSDictionary<NSString *, NSString *> * _Nonnull)requestHeaders;
/// Set the response headers.
- (void)setResponseHeaders:(NSDictionary<NSString *, NSString *> * _Nonnull)responseHeaders;
/// Creates a HTTPMetric object for a network request to record HTTP network errors.
/// \param url The URL for which the metrics are recorded.
///
/// \param httpMethod HTTP method used by the request.
///
- (nonnull instancetype)initWithUrl:(NSURL * _Nonnull)url httpMethod:(NSString * _Nonnull)httpMethod;
/// Creates a HTTPMetric object for a network request to record HTTP network errors.
/// \param request The request for which the metrics are recorded.
///
